...
rm -rf web/output/bundle/programs/server/npm/npm-container/node_modules/serialport && cp -r cache/node_modules/serialport web/output/bundle/programs/server/npm/npm-container/node_modules/serialport